...
class MnistClassificationDataset(Dataset):
    r"""
    A simple dataset class for mnist image classification with class labels.
    """
    def __init__(self, split, im_path, im_ext='png'):
        r"""
        Init method for initializing the dataset properties
...
class GeneratedDataset(Dataset):
    r"""
    A simple dataset class to store generated images and corresponding preference labels.
    """
